  ...
  const Submit = async (data) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        icon: 'success',
        html: 'You can <a href="https://api.whatsapp.com/send?phone=918879949404" target="_blank" style="color: #007bff; text-decoration: none;">WhatsApp us at +91-8879949404</a>',
